...
const fr_messages = {
  message: {
    ...
    _new:                      'Nouveau',
    new_pic:                   'Voulez-vous partir sur un nouveau projet ? Attention : cette opération supprimera toutes les actions sur le projet en cours',
    _update:                   'Mise à jour',
    update_pic:                'Vous désirez remplacer le fichier svg ?',
